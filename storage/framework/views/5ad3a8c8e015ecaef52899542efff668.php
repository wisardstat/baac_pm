<?php $__env->startSection('title', 'General Widget'); ?>
                    ...
                    <div class="card-body">
                        <div class="widget-content">
                            <div class="widget-round success">
                                <div class="bg-round"><svg>
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#c-customer')); ?>"> </use>
                                    </svg><svg class="half-circle svg-fill">
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#halfcircle')); ?>"></use>
                                    </svg></div>
                            </div>
                                ...
                                <div class="course-widget">
                                    ...
                                    <div>
                                        <h4 class="mb-0"> <span class="counter" data-target="100">0</span>+
                                            ...
                                            class="btn btn-light f-light" href="<?php echo e(route('admin.course_list')); ?>">View course<span
                                                class="ms-2">
                    ...
                    <div class="card-header card-no-border">
                        <div class="header-top">
                            <h5 class="m-0">Website Traffic<span class="f-14 font-primary f-w-500 ms-1"><svg
                                        class="svg-fill me-1">
                                        <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#user-visitor')); ?>"></use>
                                    </svg>(+2.8)</span></h5>
                            ...
                            <div class="card-header card-no-border">
                                <div class="header-top">
                                    <div class="compare-icon shadow-primary"><svg class="fill-primary">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#crm-user')); ?>"></use>
                                        </svg></div>
                                    <div class="dropdown icon-dropdown"><button class="btn dropdown-toggle"
                            ...
                            <div class="card-header card-no-border">
                                <div class="header-top">
                                    <div class="compare-icon shadow-success"><svg class="fill-success">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#crm-lead')); ?>"></use>
                                        </svg></div>
                                    <div class="dropdown icon-dropdown"><button class="btn dropdown-toggle"
                            ...
                            <div class="card-header card-no-border">
                                <div class="header-top">
                                    <div class="compare-icon shadow-warning"><svg class="fill-warning">
                                            <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#crm-deal')); ?>"></use>
                                        </svg></div>
                                    <div class="dropdown icon-dropdown"><button class="btn dropdown-toggle"
                                ...
                                <div class="header-top">
                                    ...
                                    <div>
                                        <div class="analytics-tread bg-light-primary"><svg class="fill-primary">
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#analytics-user')); ?>">
                                                </use>
                                            </svg></div>
                                    </div>
                                </div>
                                ...
                                <div class="header-top">
                                    ...
                                    <div>
                                        <div class="analytics-tread bg-light-secondary"><svg class="fill-secondary">
                                                <use href="<?php echo e(asset('assets/svg/icon-sprite.svg#analytics-view')); ?>">
                                                </use>
                                            </svg></div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.simple.master', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\MyProject\baac_pm\resources\views/widgets/general_widget.blade.php ENDPATH**/ ?>