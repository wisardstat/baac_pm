                                                    ...
                                                    <div class="flex-grow-1">
                                                        <div class="dropdown">
                                                            <button class="btn btn-primary dropdown-toggle"
                                                                :class="this.active ? 'show' : ''" id="dropdownMenuButton"
                                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                                aria-expanded="false" @click="isActive()">Action</button>
                                                            <div class="dropdown-menu" :class="this.active ? 'show' : ''"
                                        ...
                                        <div class="d-flex" v-for="(item, index) in menu" :key="index">
                                            <div class="d-flex-size-email">
                                                <label class="d-block mb-0">
                                                    <input class="checkbox_animated" v-model="item.checkbox"
                                                        type="checkbox">
                                                </label>
                                                <vue-feather class="like" type="star"></vue-feather><img
                                                    class="me-3 rounded-circle" :src="getImgUrl(item.image)" alt="">
                                            </div>
                                            <div class="flex-grow-1">
                                                <h6>{{ item.name }} </h6>
