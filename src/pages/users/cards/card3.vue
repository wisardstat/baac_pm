    ...
    <div class="card social-profile">
      <div class="card-body">
        ...
        <div class="social-details">
          <h5 class="mb-1"><router-link to="/app/socialPage">Douglas Reichel</router-link></h5><span
  ...
  <div class="col-xl-4 col-sm-6 col-xxl-3 col-ed-4 box-col-4">
    <div class="card social-profile">
      <div class="card-body">
        ...
        <div class="social-details">
          <h5 class="mb-1"><router-link to="/app/socialPage">Lisa lillian</router-link></h5><span
