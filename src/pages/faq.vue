              ...
              <div class="col-xl-8 xl-60 col-lg-6 col-md-7">
                <div class="card">
                  <div class="class-header">
                    <h5 class="mb-0">
                      <button type="button" class="btn btn-link collapsed" aria-expanded="false"
                        aria-controls="collapseicon12" style="overflow-anchor: none">
                        <vue-feather type="help-circle"></vue-feather> Integrating
                        WordPress with Your Website?
                      </button>
                    </h5>
                  </div>
                  <div id="collapseicon12" role="tabpanel" style="display: none" class="collapse">
                    <div class="card-body">
                      >Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
                      Aenean commodo ligula eget dolor. Aenean massa. Cum sociis
                      natoque penatibus et magnis dis parturient montes,
                ...
                <div class="card">
                  <div class="class-header">
                    <h5 class="mb-0">
                      <button type="button" class="btn btn-link collapsed" aria-expanded="false"
                        aria-controls="collapseicon13" style="overflow-anchor: none">
                  ...
                  <div id="collapseicon13" role="tabpanel" style="display: none" class="collapse">
                ...
                <div class="card">
                  <div class="class-header">
                    <h5 class="mb-0">
                      <button type="button" class="btn btn-link collapsed" aria-expanded="false"
                        aria-controls="collapseicon13" style="overflow-anchor: none">
                        <vue-feather type="help-circle"></vue-feather> Validating a
                        Website ?
                      </button>
                    </h5>
                  </div>
                ...
                <div class="card">
                  <div class="class-header">
                    <h5 class="mb-0">
                      <button type="button" class="btn btn-link collapsed" aria-expanded="false"
                        aria-controls="collapseicon13" style="overflow-anchor: none">
                        <vue-feather type="help-circle"></vue-feather> Know Your Sources
                        ?
                      </button>
                    </h5>
                  </div>
                  ...
                  <div class="col-lg-12">
                    <div class="card card-mb-faq xs-mt-search">
                      ...
                      <div class="card-body faq-body">
                        <div class="faq-form">
                          <input class="form-control" type="text" placeholder="Search.." /><vue-feather
                            class="search-icon" type="search"></vue-feather>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="card card-mb-faq">
                      ...
                      <div class="card-body faq-body">
                        <div class="navigation-btn">
                          <a class="btn btn-primary" href="#"><vue-feather class="m-r-10"
                              type="message-square"></vue-feather>Ask Question</a>
                        </div>
                        <div class="navigation-option">
                          <ul>
                            <li>
                              <a href="#"><vue-feather type="edit"></vue-feather>Tutorials</a>
                            </li>
                            <li>
                              <a href="#"><vue-feather type="globe"></vue-feather>Help center</a>
                            </li>
                            <li>
                              <a href="#"><vue-feather type="book-open"></vue-feather>Knowledgebase</a>
                            </li>
                            <li>
                              <a href="#"><vue-feather type="file-text"></vue-feather>Articles</a><span
                                class="badge badge-primary rounded-pill pull-right">42</span>
                            </li>
                            <li>
                              <a href="#"><vue-feather type="youtube"></vue-feather>Video
                                Tutorials</a><span class="badge badge-primary rounded-pill pull-right">648</span>
                            </li>
                            <li>
                              <a href="#"><vue-feather type="message-circle"></vue-feather>Ask
                                our community</a>
                            </li>
                            <li>
                              <a href="#"><vue-feather type="mail"></vue-feather>Contact us</a>
                            </li>
                          </ul>
                          <hr />
                          <ul>
                      ...
                      <div class="card-body faq-body">
                        <div class="media updates-faq-main">
                          <div class="updates-faq">
                            <vue-feather type="rotate-cw" class="font-primary"></vue-feather>
                          </div>
                        ...
                        <div class="media updates-faq-main">
                          <div class="updates-faq">
                            <vue-feather type="dollar-sign" class="font-primary"></vue-feather>
                          </div>
                          <div class="media-body updates-bottom-time">
                        ...
                        <div class="media updates-faq-main">
                          <div class="updates-faq">
                            <vue-feather type="link" class="font-primary"></vue-feather>
                          </div>
                          <div class="media-body updates-bottom-time">
                            <p>
                        ...
                        <div class="media updates-faq-main">
                          <div class="updates-faq">
                            <vue-feather type="check" class="font-primary"></vue-feather>
                          </div>
                          <div class="media-body updates-bottom-time">
                            <p>
