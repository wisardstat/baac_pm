                        ...
                        <tbody>
                            <tr>
                                <td style="padding: 30px">
                                    ...
                                    <p>You forgot your password for Cuba Admin. If this is true, click below to reset
                                        your password.</p>
                                    <p style="text-align: center"><a href="{{ route('admin.reset_password') }}"
                                            style="padding: 10px; background-color: #7366ff; color: #fff; display: inline-block; border-radius: 4px">Reset
                                            Password</a></p>
