                                            ...
                                            <tr>
                                                <td style="padding: 30px">
                                                    ...
                                                    <div class="text-center"><a href="{{ route('admin.contacts') }}"
                                                            style="padding: 10px; background-color: #7366ff; color: #fff; display: inline-block; border-radius: 4px; margin-bottom: 18px">Call
                                                            To Action </a></div>
                                            ...
                                            <tr style="text-align: center">
                                                <td>
                                                    ...
                                                    <p style="color: #999; margin-bottom: 0">Don't Like These Emails? <a
                                                            href="#" style="color: #7366ff">Unsubscribe</a></p>
